...
namespace DotNetMidtermA.Controllers
{
    ...
    {
        private FlightsModel db = new FlightsModel();

        // GET: Flights
        public ActionResult Index()
        {
            var flights = db.Flights.Include(f => f.FlightType).Include(f => f.Province);
        ...
        public ActionResult Create([Bind(Include = "FlightId,FlightTypeId,ProvinceId,ExtraBag,FirstName,LastName")] Flights flight)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FlightId,FlightTypeId,ProvinceId,ExtraBag,FirstName,LastName")] Flights flight)
        {
            if (ModelState.IsValid)
            {
